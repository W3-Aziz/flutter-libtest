...
import 'package:lib_practics/snapping/placeholder_example.dart';
import 'package:lib_practics/snapping/preview_page.dart';
import 'package:lib_practics/snapping/preview_reverse_page.dart';
...
class Menu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const DarkAppBar(title: "Other Examples").build(context),
      body: Container(
